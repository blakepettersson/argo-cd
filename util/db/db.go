...
type ArgoDB interface {
	...
	GetRepositoryCredentials(ctx context.Context, name, project string) (*appv1.RepoCreds, error)
	...
	DeleteRepositoryCredentials(ctx context.Context, name, project string) error
