...
type RepoCreds struct {
	...
	// Reference that allows repo creds to be automatically scoped per project, if added
	Project string `json:"project,omitempty" protobuf:"bytes,21,opt,name=project"`
}
